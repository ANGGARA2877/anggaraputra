        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Resume</a></li>
            ...
            <li><a class="smoothscroll" href="#testimonials">sedikit_kata</a></li>
         </ul> <!-- end #nav -->
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
           ...
           <img src="dist\img\Anggara.png" alt=""> 
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>Biarkan musik mengalun dalam hidupmu, Tapi jangan Biarkan hidupmu tergantung pada nadanya.
                           </p>
                           <cite>Anggara</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
                     ...
                     <li>
                        <blockquote>
                           <p>jika dunia seperti papan catur. maka temukan lawan yang seimbang untuk bermain.
                           </p>
                           <cite>anggara</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
