      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="social-links">
               <li><a target ="_blank" href="<?php echo $contact['facebook'] ?>"><i class="fa fa-youtube"></i></a></li>
               <li><a target ="_blank" href="<?php echo $contact['twitter'] ?>"><i class="fa fa-instagram"></i></a></li>
               <li><a target ="_blank" href="<?php echo $contact['linkin'] ?>"><i class="fa fa-github"></i></a></li>
            </ul>

            <ul class="copyright">
               <li>WEB &copy; Copyright AnggaraPutra</li>
            </ul>
